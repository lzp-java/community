...
import lzp.study.community.community.mapper.UserMapper;
import lzp.study.community.community.model.User;
...
public class AuthorizeController {
    ...
    @Value("${github.redirect.url")//指向配置文件中的github.redirect.url
